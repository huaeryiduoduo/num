...
<h1>
<span class="action-span"><a href="/shiyi/index.php/Home/Brand/add">商品品牌</a></span>
<span class="action-span1"><a href="index.php?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加品牌 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
<form method="post" action="/shiyi/index.php/Home/Brand/add" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td><input type="text" name="sort" maxlength="40" size="15" value="50"></td>
  </tr>
  <tr>
