		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo U('goods/index');?>" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="<?php echo U('brand/index');?>" target="main-frame">添加商品</a></li>
