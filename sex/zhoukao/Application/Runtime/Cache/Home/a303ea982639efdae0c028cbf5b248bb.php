...
<head>
	...
	<title></title><base href="/zhoukao/Public/admin/"/>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="goods.php?act=list" target="main-frame">商品管理</a></li>
						  <li class="menu-item"><a href="<?php echo U('cat/index');?>" target="main-frame">分类管理</a></li>
